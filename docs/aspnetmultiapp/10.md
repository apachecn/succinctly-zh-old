...
除此之外，我们需要更改 [DbContext](https://msdn.microsoft.com/en-us/library/system.data.entity.dbcontext%28v=vs.113%29.aspx) 派生类，使其继承自 MultitenantIdentityDbContext&lt; ApplicationUser&gt; 也是：
